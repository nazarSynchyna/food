...
exports["default"] = void 0;
var _modal = __webpack_require__(/*! ./modal */ "./src/js/modules/modal.js");
var _services = __webpack_require__(/*! ../services/services */ "./src/js/services/services.js");
...
function slider({
  ...
  next.addEventListener("click", () => {
    ...
    if (offset == widthNum * (slides.length - 1)) offset = 0;else offset += widthNum;
    if (slideIndex == slides.length) slideIndex = 1;else slideIndex++;
    updateSliderUI();
  });
  prev.addEventListener("click", () => {
    const widthNum = deleteNotDigits(width);
    if (offset === 0) offset = widthNum * (slides.length - 1);else offset -= widthNum;
...
var _tabs = _interopRequireDefault(__webpack_require__(/*! ./modules/tabs */ "./src/js/modules/tabs.js"));
var _modal = _interopRequireWildcard(__webpack_require__(/*! ./modules/modal */ "./src/js/modules/modal.js"));
var _timer = _interopRequireDefault(__webpack_require__(/*! ./modules/timer */ "./src/js/modules/timer.js"));
var _cards = _interopRequireDefault(__webpack_require__(/*! ./modules/cards */ "./src/js/modules/cards.js"));
var _calc = _interopRequireDefault(__webpack_require__(/*! ./modules/calc */ "./src/js/modules/calc.js"));
var _forms = _interopRequireDefault(__webpack_require__(/*! ./modules/forms */ "./src/js/modules/forms.js"));
var _slider = _interopRequireDefault(__webpack_require__(/*! ./modules/slider */ "./src/js/modules/slider.js"));
...
window.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => (0, _modal.openModal)(".modal", modalTimerId), 50000);
  ...
  (0, _timer.default)(".timer", "2026-07-20");
  (0, _cards.default)();
  (0, _calc.default)();
